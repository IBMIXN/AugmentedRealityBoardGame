...
namespace TbsFramework.Units
{
    public class MyUnit : Unit
    {
        ...
        protected void UpdateHpBar()
        {
            ...
            {
                float healthRatio = Data.getCurrentDurability() / Data.getMaxDurability();
                GetComponentInChildren<Image>().transform.localScale = new Vector3(healthRatio, 1, 1);
                GetComponentInChildren<Image>().color = Color.Lerp(Color.red, Color.green, healthRatio);
            }
        }
